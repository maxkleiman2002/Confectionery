...
<form action="vendor/registration_check.php" method="POST">
    <div class="form-wrapper">
        ...
        <div class="group">
            <label for="name">Ім'я: </label> <input type="text"  name="name" id="name"/>
        </div>

        <div class="group">
            <label for="surname">Прізвище: </label> <input type="text"  name="surname" id="surname"/>
        </div>

        <div class="group">
           <label for="patronymic">Ім'я по-батькові: </label> <input type="text"  name="patronymic" id="patronymic"/>
        </div>
        ...
        <div class="group">
            <label for="birth-month">Місяць народження: </label>
        ...
        <div class="group">
            <label for="birth-year">Рік народження: </label>
        ...
        <div class="group">
            ...
            <?php
            if ($_SESSION['message']) {
                echo '<div class="err-msg"> ' . $_SESSION['message'] . ' </div>';
            }
            unset($_SESSION['message']);
            ?>
            <?php
            if ($_SESSION['message2']) {
                echo '<div class="err-msg2" > ' . $_SESSION['message2'] . ' </div>';
            }
